...
assert.ok(['STEP064B4D1', 'STEP064B4D1A', 'STEP064B4D2', 'STEP064B4D2A'].includes(CURRENT_SOURCE_STEP));
assert.ok(['0.64.8', '0.64.9', '0.65.0', '0.65.1'].includes(packageJson.version));
