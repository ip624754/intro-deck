...
for (const fragment of ['👑 Админка', 'Сначала выберите раздел.', 'Готовы, но не опубликованы: 11', 'Уведомление: активно']) {
...
for (const fragment of ['🧰 Операции', 'Пользовательская воронка: LinkedIn', 'Проблемы доставки: 4']) {
