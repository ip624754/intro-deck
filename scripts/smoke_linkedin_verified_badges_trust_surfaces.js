...
assert.equal(help.includes('Identity verified and Workplace verified are separate LinkedIn categories.'), true);
assert.equal(help.includes('Public badges require LinkedIn Lite mode'), true);
...
assert.equal(adminSurface.includes('LinkedIn trust: identity'), true);
...
assert.equal(['STEP058B', 'STEP058B1', 'STEP059', 'STEP060', 'STEP061', 'STEP061H1', 'STEP061A', 'STEP063A', 'STEP063A-H1', 'STEP063A-H1A', 'STEP063B', 'STEP063B-H1', 'STEP063B-H1R1', 'STEP063B-H2', 'STEP064A'].includes(CURRENT_SOURCE_STEP), true);
