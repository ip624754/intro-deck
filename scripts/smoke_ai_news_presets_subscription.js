...
assert.equal(['STEP063B-H2', 'STEP064A', 'STEP064B1', 'STEP064B2', 'STEP064B3', 'STEP064B4A', 'STEP064B4B', 'STEP064B4C', 'STEP064B4C1', 'STEP064B4D1', 'STEP064B4D1A'].includes(CURRENT_SOURCE_STEP), true);
assert.equal(['0.63.6', '0.64.0', '0.64.1', '0.64.2', '0.64.3', '0.64.4', '0.64.5', '0.64.6', '0.64.7', '0.64.8', '0.64.9'].includes(packageJson.version), true);
