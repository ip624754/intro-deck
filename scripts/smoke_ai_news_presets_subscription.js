...
assert.equal(['STEP063B-H2', 'STEP064A', 'STEP064B1', 'STEP064B2', 'STEP064B3'].includes(CURRENT_SOURCE_STEP), true);
assert.equal(['0.63.6', '0.64.0', '0.64.1', '0.64.2', '0.64.3'].includes(packageJson.version), true);
