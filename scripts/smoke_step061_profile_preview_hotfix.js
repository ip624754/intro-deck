...
assert.equal(packageJson.version, '0.63.5');
assert.equal(
...
assert.match(releaseSource, /CURRENT_SOURCE_STEP = '(?:STEP061H1|STEP061A|STEP063A|STEP063A-H1A|STEP063B|STEP063B-H1|STEP063B-H1R1)'/);
