...
export default async function handler(req, res) {
  ...
  res.status(200).json({
    ...
    linkedInShareConversionDashboardPolicy: {
      ...
      ownerSurface: 'profile_linkedin_performance',
      adminSurface: 'operations_linkedin_share_dashboard',
      metrics: ['published_posts', 'total_opens', 'unique_opens', 'unique_started', 'unique_submitted', 'unique_approved'],
      conversionRates: ['unique_open_to_request', 'unique_request_to_approval'],
      recentWindowDays: 7,
      perPostDrilldown: true,
      visitorIdentityVisibleToOwner: false,
      visitorIdentityVisibleToAdmin: false,
      internalUserIdsVisible: false,
      readOnly: true,
